...
<jsp:useBean id="todayratesList" class="java.util.ArrayList"
...
<!-- end of menu --></div>
<div>
<h3><font color="#df7000">Today's Rates</font></h3>
</div>
...
<table>
	...
	<table class="tableborder">
		<tr>
			...
			<td width="100" class="tdborder"><b><font color="#df7000">Price/Qtl</font></b></td>
		</tr>
		<%
		Iterator itr = todayratesList.iterator();
		%>

		<%int 	i=1;
		RWBean rBean =null;
				while (itr.hasNext()) {
				rBean = (RWBean) itr.next();
		%>

		<tr>

			<td width="100" class="tdborder1"><%=i%></td>
			<td width="100" class="tdborder1"><%=rBean.getVegname()%></td>
			<td width="100" class="tdborder1"><%=rBean.getPrice()%></td>
	...
	<center>
	<h5>Last Update on <%=rBean.getDate()%></h5>
	</center>
	</div>
	<!-- end of section 1 -->
